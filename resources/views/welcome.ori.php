...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
	...
	<div id="page-container">
			...
			<div class="container d-flex">
				<div class="header-logo">
					<a href="index.html" class="logo-link">
						<span class="logo"></span><b>AniMae</b> <small>Community</small>
					</a>
				</div>
		...
		<div class="section pt-4 pb-0 mb-5 d-md-none" >
			<h1 class="text-warning text-center display-5 fw-bolder " style="padding-top: 16rem; padding-bottom: 16rem;" >AniMae</h1>
		</div>
		<!-- END section -->
			...
			<div class="container">
				...
				<div class="row gx-0 align-items-center">
					...
					<div class="col-lg-6 mb-4 mb-lg-0">
						<img class="mw-100" src="{{ asset('')}}img/corporate/img-7.jpg" alt="" />
					</div>
					<!-- END col-6 -->
					<!-- BEGIN col-6 -->
			...
			<div class="container position-relative">
				...
				<div class="row gx-5 align-items-center">
					...
					<div class="col-lg-6">
						...
						Gabung Animae dan buka sisi kreatif wibu yang kamu miliki! Cosplay, konten, bersenang-senang, dan tumbuh bersama dalam komunitas yang memiliki tujuan yang sama
						</div>
					</div>
					<!-- END col-6 -->
					<!-- BEGIN col-6 -->
					<div class="col-lg-6">
						<img class="mw-100" src="{{ asset('')}}img/corporate/img-13.jpg" alt="" />
					</div>
					<!-- END col-6 -->
				</div>
				<!-- END row -->
		...
		<div class="section">
			<div class="container">
				<h4 class="mb-4">Our Executives</h4>
				<!-- BEGIN row -->
				<div class="row gx-5">
					<!-- BEGIN col-3 -->
					<div class="col-sm-6 col-md-4 col-lg-3">
						<!-- BEGIN news -->
						<div class="news mb-5">
							<div class="news-media mb-3">
								<div class="news-media-img news-media-img-lg" style="background-image:url(img/corporate/user-1.jpg);"></div>
							</div>
							<div class="fw-bold fs-16px">Umar Wallace, Founder, Chairman and Chief Executive Officer</div>
					...
					<div class="col-sm-6 col-md-4 col-lg-3">
						...
						<div class="news mb-5">
							<div class="news-media mb-3">
								<div class="news-media-img news-media-img-lg" style="background-image:url(img/corporate/user-2.jpg);"></div>
							</div>
							<div class="fw-bold fs-16px">Eiliyah Salinas, Chief Operating Officer</div>
							<a href="#" class="stretched-link"></a>
						</div>
						<!-- END news -->
					</div>
					...
					<div class="col-sm-6 col-md-4 col-lg-3">
						...
						<div class="news mb-5">
							<div class="news-media mb-3">
								<div class="news-media-img news-media-img-lg" style="background-image:url(img/corporate/user-3.jpg);"></div>
							</div>
							<div class="fw-bold fs-16px">Rikesh Callahan, Chief Technology Officer</div>
							<a href="#" class="stretched-link"></a>
						</div>
						<!-- END news -->
					</div>
					...
					<div class="col-sm-6 col-md-4 col-lg-3">
						...
						<div class="news mb-5">
							<div class="news-media mb-3">
								<div class="news-media-img news-media-img-lg" style="background-image:url(img/corporate/user-4.jpg);"></div>
							</div>
							<div class="fw-bold fs-16px">Ozan Nolan, Chief Financial Officer</div>
							<a href="#" class="stretched-link"></a>
						</div>
						<!-- END news -->
					</div>
					...
					<div class="col-sm-6 col-md-4 col-lg-3">
						...
						<div class="news mb-5">
							<div class="news-media mb-3">
								<div class="news-media-img news-media-img-lg" style="background-image:url(img/corporate/user-5.jpg);"></div>
							</div>
							<div class="fw-bold fs-16px">Aila Thornton, Chief Product Officer</div>
							<a href="#" class="stretched-link"></a>
						</div>
						<!-- END news -->
					</div>
					...
					<div class="col-sm-6 col-md-4 col-lg-3">
						...
						<div class="news mb-5">
							<div class="news-media mb-3">
								<div class="news-media-img news-media-img-lg" style="background-image:url(img/corporate/user-6.jpg);"></div>
							</div>
							<div class="fw-bold fs-16px">Kamron Cox, Chief Marketing Officer and VP of Analytics</div>
							<a href="#" class="stretched-link"></a>
						</div>
						<!-- END news -->
					</div>
					...
					<div class="col-sm-6 col-md-4 col-lg-3">
						...
						<div class="news mb-5">
							<div class="news-media mb-3">
								<div class="news-media-img news-media-img-lg" style="background-image:url(img/corporate/user-7.jpg);"></div>
							</div>
							<div class="fw-bold fs-16px">Fergus Ramsey, Chief Revenue Officer</div>
							<a href="#" class="stretched-link"></a>
						</div>
						<!-- END news -->
					</div>
					...
					<div class="col-sm-6 col-md-4 col-lg-3">
						...
						<div class="news mb-5">
							<div class="news-media mb-3">
								<div class="news-media-img news-media-img-lg" style="background-image:url(img/corporate/user-8.jpg);"></div>
							</div>
							<div class="fw-bold fs-16px">Persephone Myers, General Counsel</div>
							<a href="#" class="stretched-link"></a>
						</div>
						<!-- END news -->
					</div>
					...
					<div class="col-sm-6 col-md-4 col-lg-3">
						...
						<div class="news mb-5">
							<div class="news-media mb-3">
								<div class="news-media-img news-media-img-lg" style="background-image:url(img/corporate/user-9.jpg);"></div>
							</div>
							<div class="fw-bold fs-16px">Jorden Reed, Chief Diversity Officer</div>
							<a href="#" class="stretched-link"></a>
						</div>
						<!-- END news -->
					</div>
					...
					<div class="col-sm-6 col-md-4 col-lg-3">
						...
						<div class="news mb-5">
							<div class="news-media mb-3">
								<div class="news-media-img news-media-img-lg" style="background-image:url(img/corporate/user-10.jpg);"></div>
							</div>
							<div class="fw-bold fs-16px">Eiliyah Mcconnell, Chief Privacy Officer</div>
							<a href="#" class="stretched-link"></a>
						</div>
						<!-- END news -->
					</div>
