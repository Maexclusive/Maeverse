                    ...
                    <div class="panel-body">
                        ...
                        <div class="modal fade m-3" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        <input type="text" class="form-control mb-3" name="company_name" placeholder="Masukan Nama Company" required>
                                        {{-- <input type="text" class="form-control" name="nama_domain" placeholder="Masukan Domain" required> --}}
                                    </div>

                                    {{-- <div class="text-secondary text-start"><i class="fas fa-square-plus fa-md"></i> Aditional Column</div>
                                    <hr>
                        ...
                        <table id="data-table-combine" class="table table-striped table-bordered align-middle">
                            <thead>
                                <tr>
                                    <th width="1%">No</th>
                                    <th class="text-nowrap" width="80%">Company Name</th>
                            ...
                            <tbody>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td> <form action="{{ route('Company.destroy',$c->company_id) }}" method="POST">
